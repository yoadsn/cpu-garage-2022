...
assign lcd_db = //rgb_data_off_frame ==1? 8'b10101010:
	...
	begin
		...
		case(rgb_state)
			...
			RGB_IDLE: begin
							...
							if (rgb_on == 1) begin
								rgb_next_state = RGB_WAIT_START_D;
								rgb_lcd_wr = 1;
							end
							else begin
									rgb_next_state = RGB_IDLE;
			...
			RGB_WAIT_START_D: begin
									...
									if (first_pixle == 1) begin
										...
										//rgb_data_off_frame = 1;
										rgb_next_state = RGB_WAIT_START_D;
										//rgb_lcd_wr = 0;
									end
								end

			RGB_WAIT_START_U: begin
									rgb_next_state = RGB_WAIT_START_D;
									rgb_lcd_wr = 1;
								end
